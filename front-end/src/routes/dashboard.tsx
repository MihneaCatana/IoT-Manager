...
function RouteComponent() {
  ...
  const totalDevices = spaces.reduce(
    (sum, space) => sum + space.deviceCount,
    0
  );
  const totalActiveDevices = spaces.reduce(
    (sum, space) => sum + space.activeDevices,
    0
  );
  return (
    <Layout>
      <div className="bg-gray-50 p-10">
              ...
              >
                ...
                <CardContent className="pb-2">
                  <div className="flex justify-between text-sm">
                    <span>Devices</span>
                    <span className="font-medium">{space.deviceCount}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span>Active</span>
                ...
                <CardFooter className="pt-0">
                  <div className="w-full">
                    <div className="flex justify-between text-xs mb-1">
                      <span>Status</span>
                      <span>
                        {space.activeDevices}/{space.deviceCount} online
                      </span>
                    </div>
                    <Progress
                      value={(space.activeDevices / space.deviceCount) * 100}
                      className="h-2"
                    />
                  </div>
                </CardFooter>
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            {selectedSpace.activeDevices} of {selectedSpace.deviceCount} devices
            online
          </p>
        </div>
